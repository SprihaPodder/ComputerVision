...
// Mac sound function
void playPopSound() {
    system("afplay pop.wav &");
}

// Explosion
void spawnExplosion(Point p){
    ...
    for(int i=0;i<20;i++){
        ...
        float angle = rng.uniform(0.f, (float)(2*CV_PI));
        float speed = rng.uniform(2.0f, 6.0f);
...
int main(){
    ...
    while(true){
        ...
        // ===== GAME OVER =====
            ...
            Rect lbBtn(300,370,200,70);
            Rect backBtn(300,460,200,80);

            rectangle(game, lbBtn,
                Scalar(0,150,200),-1);
            ...
            // check hover priority
            if(gameCentroid.x!=-1){

                if(lbBtn.contains(gameCentroid)){

                    if(hoverClick(lbBtn))
                        state=LEADERBOARD;

                } else if(backBtn.contains(gameCentroid)){
        ...
        // ===== LEADERBOARD =====
            ...
            if(gameCentroid.x!=-1){
                ...
                if(backBtn.contains(gameCentroid)){
